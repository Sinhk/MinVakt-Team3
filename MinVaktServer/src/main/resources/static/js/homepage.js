$(document).ready(function(){
    ...
    $('#calendar').fullCalendar({
        ...
        eventMouseover: function(calEvent, jsEvent) {
            var tooltip = '<div class="tooltipevent" style="width:150px;height:50px;background:#e3f2fd;border-style:solid;border-color:#212121;border-width:1px;position:absolute;z-index:10001;">' + ' ' + ' Tidspunkt: ' + calEvent.title + '<br> Avdeling: ' +calEvent.avdeling+ '<br>  Ansvar: '+calEvent.isResponsible+'</div>';
