...
public class PBKDF2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PBKDF2 krypt = new PBKDF2();

        String passord = showInputDialog(null, "Passord?");
        ...
        System.out.println("Godkjent: " + krypt.authenticate("olav", encrypted, salt));
